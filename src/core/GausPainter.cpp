    ...
    ModelObject * model_object, const std::string & name)
{
    ...
    pad[5] = ROOTHelper::CreatePad("pad5","", 0.00, 0.80, 1.00, 1.00); // The title pad
    frame[1] = ROOTHelper::CreateHist2D("hist_1","", 100, 0.0, 1.0, 100, 0.0, 1.0);
    frame[0] = ROOTHelper::CreateHist2D("hist_0","", 100, 0.0, 1.0, 100, 0.0, 1.0);
    frame[3] = ROOTHelper::CreateHist2D("hist_3","", 100, 0.0, 1.0, 100, 0.0, 1.0);
    frame[2] = ROOTHelper::CreateHist2D("hist_2","", 100, 0.0, 1.0, 100, 0.0, 1.0);
    ...
    for (auto & [component_key, component_entry] : chemical_component_map)
    {
        ...
        pad[1]->cd();
        ROOTHelper::SetPadMarginInCanvas(gPad, 0.07, 0.01, 0.02, 0.01);
        ROOTHelper::SetPadFrameAttribute(gPad, 0, 0, 4000, 0, 0, 0);
        RemodelFrameInPad(frame[1].get(), pad[1].get(), 0.0, 0.015);
        RemodelAxisLabels(frame[1].get(), atom_id_list, 90.0, 12);
        ROOTHelper::SetAxisTitleAttribute(frame[1]->GetXaxis(), 0.0f);
        ROOTHelper::SetAxisTitleAttribute(frame[1]->GetYaxis(), 40.0f, 1.35f);
        ROOTHelper::SetAxisLabelAttribute(frame[1]->GetXaxis(), 0.0f);
        ROOTHelper::SetAxisLabelAttribute(frame[1]->GetYaxis(), 35.0f, 0.01f);
        frame[1]->GetYaxis()->SetTitle("Amplitude");
        frame[1]->Draw();
        for (auto & [element, graph] : amplitude_graph_map) graph->Draw("P");

        pad[0]->cd();
        ROOTHelper::SetPadMarginInCanvas(gPad, 0.07, 0.01, 0.11, 0.02);
        ROOTHelper::SetPadFrameAttribute(gPad, 0, 0, 4000, 0, 0, 0);
        RemodelFrameInPad(frame[0].get(), pad[0].get(), 0.0, 0.015);
        RemodelAxisLabels(frame[0].get(), atom_id_list, 90.0, 12);
        ROOTHelper::SetAxisTitleAttribute(frame[0]->GetXaxis(), 0.0f);
        ROOTHelper::SetAxisTitleAttribute(frame[0]->GetYaxis(), 40.0f, 1.35f);
        ROOTHelper::SetAxisLabelAttribute(frame[0]->GetXaxis(), 35.0f, 0.11f, 103, kCyan+3);
        ROOTHelper::SetAxisLabelAttribute(frame[0]->GetYaxis(), 35.0f, 0.01f);
        frame[0]->GetYaxis()->SetTitle("Width");
        frame[0]->Draw();
        for (auto & [element, graph] : width_graph_map) graph->Draw("P");

        pad[3]->cd();
        ROOTHelper::SetPadMarginInCanvas(gPad, 0.01, 0.01, 0.02, 0.01);
        ROOTHelper::SetPadFrameAttribute(gPad, 0, 0, 4000, 0, 0, 0);
        ...
        pad[2]->cd();
        ROOTHelper::SetPadMarginInCanvas(gPad, 0.01, 0.01, 0.11, 0.02);
        ROOTHelper::SetPadFrameAttribute(gPad, 0, 0, 4000, 0, 0, 0);
        RemodelFrameInPad(frame[2].get(), pad[2].get(), 0.0, 0.015);
        RemodelAxisLabels(frame[2].get(), element_label_list, 0.0, -1);
        ROOTHelper::SetAxisTitleAttribute(frame[2]->GetXaxis(), 40.0f, 0.9f);
        ROOTHelper::SetAxisTitleAttribute(frame[2]->GetYaxis(), 0.0f);
        ROOTHelper::SetAxisLabelAttribute(frame[2]->GetXaxis(), 40.0f, 0.005f, 103);
        ROOTHelper::SetAxisLabelAttribute(frame[2]->GetYaxis(), 0.0f);
        frame[2]->GetXaxis()->SetTitle("Element");
        frame[2]->Draw();
        for (auto & [element, hist] : width_hist_map) hist->Draw("CANDLE3 SAME");
        ...
        pad[4]->cd();
        ROOTHelper::SetPadMarginInCanvas(gPad, 0.01, 0.07, 0.11, 0.01);
        ROOTHelper::SetPadFrameAttribute(gPad, 0, 0, 4000, 0, 0, 0);
        RemodelFrameInPad(frame[4].get(), pad[4].get(), 0.03, 0.015);
        ROOTHelper::SetAxisTitleAttribute(frame[4]->GetXaxis(), 40.0f, 0.9f);
        ROOTHelper::SetAxisTitleAttribute(frame[4]->GetYaxis(), 40.0f, 1.3f);
        ROOTHelper::SetAxisLabelAttribute(frame[4]->GetXaxis(), 40.0f);
    ...
    TAxis * axis, const std::vector<std::string> & label_list, double angle, int align)
{
    ...
    axis->SetLimits(-1.0, static_cast<float>(label_size) - 0.5f);
