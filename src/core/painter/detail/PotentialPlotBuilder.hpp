...
public:
    ...
    std::unordered_map<std::string, std::unique_ptr<::TGraphErrors>> CreateAverageQScoreToSequenceIDGraphMap(size_t method=0, bool apply_selection=true, bool use_updated_sample=false);
