#include "BondAnalysisCommand.hpp"
...
namespace {
CommandRegistrar<BondAnalysisCommand> registrar_bond_analysis{
    "bond_analysis",
    "Run bond analysis"};
}
...
void BondAnalysisCommand::RegisterCLIOptionsExtend(CLI::App * cmd)
{
    Logger::Log(LogLevel::Debug, "BondAnalysisCommand::RegisterCLIOptionsExtend() called.");
...
bool BondAnalysisCommand::Execute(void)
{
    Logger::Log(LogLevel::Debug, "BondAnalysisCommand::Execute() called.");
...
void BondAnalysisCommand::SetAsymmetryFlag(bool value)
{
    m_options.is_asymmetry = value; 
}
void BondAnalysisCommand::SetSimulationFlag(bool value)
{
    m_options.is_simulation = value;
}

void BondAnalysisCommand::SetSimulatedMapResolution(double value)
{
    m_options.resolution_simulation = value;
}

void BondAnalysisCommand::SetFitRangeMinimum(double value)
{
    m_options.fit_range_min = value;
}

void BondAnalysisCommand::SetFitRangeMaximum(double value)
{
    m_options.fit_range_max = value;
}

void BondAnalysisCommand::SetAlphaR(double value)
{
    m_options.alpha_r = value;
}

void BondAnalysisCommand::SetAlphaG(double value)
{
    m_options.alpha_g = value;
}

void BondAnalysisCommand::SetModelFilePath(const std::filesystem::path & path)
{
...
void BondAnalysisCommand::SetMapFilePath(const std::filesystem::path & path)
{
...
void BondAnalysisCommand::SetSavedKeyTag(const std::string & tag)
{
    m_options.saved_key_tag = tag;
}

void BondAnalysisCommand::SetSamplingSize(int value)
{
...
void BondAnalysisCommand::SetSamplingRangeMinimum(double value)
{
    m_options.sampling_range_min = value;
}

void BondAnalysisCommand::SetSamplingRangeMaximum(double value)
{
    m_options.sampling_range_max = value;
}

bool BondAnalysisCommand::BuildDataObject(void)
{
    Logger::Log(LogLevel::Debug, "BondAnalysisCommand::BuildDataObject() called");
    ScopeTimer timer("BondAnalysisCommand::BuildDataObject");
    ...
    {
        Logger::Log(LogLevel::Error,
            "BondAnalysisCommand::Execute() : " + std::string(e.what()));
        return false;
    }
    return true;
}

void BondAnalysisCommand::UpdateModelObjectForSimulation(ModelObject * model_object)
{
    Logger::Log(LogLevel::Debug, "BondAnalysisCommand::UpdateModelObjectForSimulation() called");
...
void BondAnalysisCommand::RunMapObjectPreprocessing(void)
{
    Logger::Log(LogLevel::Debug, "BondAnalysisCommand::RunMapObjectPreprocessing() called");
    ScopeTimer timer("BondAnalysisCommand::RunMapObjectPreprocessing");
    auto data_manager{ GetDataManagerPtr() };
    m_map_object = data_manager->GetTypedDataObject<MapObject>(m_map_key_tag);
    m_map_object->MapValueArrayNormalization();
}

void BondAnalysisCommand::RunModelObjectPreprocessing(void)
{
    Logger::Log(LogLevel::Debug, "BondAnalysisCommand::RunModelObjectPreprocessing() called");
    ScopeTimer timer("BondAnalysisCommand::RunModelObjectPreprocessing");
    auto data_manager{ GetDataManagerPtr() };
...
void BondAnalysisCommand::RunMapValueSampling(void)
{
...
void BondAnalysisCommand::RunPotentialFitting(void)
{
    Logger::Log(LogLevel::Debug, "BondAnalysisCommand::RunPotentialFitting() called");
    ScopeTimer timer("BondAnalysisCommand::RunPotentialFitting");
