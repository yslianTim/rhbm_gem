...
std::unique_ptr<MapObject> MrcFormat::ReadMap(
    ...
    try {
        ...
        throw std::runtime_error("MrcFormat::Read() failed for '" + source_name + "': " + ex.what());
    }
    ...
    Logger::Log(LogLevel::Debug,
                ...
                "Array Size: " +
                    ...
                    std::to_string(m_header.grid_size[0]) + " x " + std::to_string(m_header.grid_size[1]) + " x " + std::to_string(m_header.grid_size[2]) + "\n"
                                                                                                                                                            "Map Length: " +
                    std::to_string(m_header.cell_dimension[0]) + ", " + std::to_string(m_header.cell_dimension[1]) + ", " + std::to_string(m_header.cell_dimension[2]) + "\n"
                                                                                                                                                                         "Cell Angles: " +
                    ...
                    std::to_string(m_header.space_group) + "\n"
                                                           "Extra Size: " +
                    std::to_string(m_header.extra_size) + "\n"
                                                          "Tilt angles: " +
                    std::to_string(m_header.tiltangles[0]) + ", " + std::to_string(m_header.tiltangles[1]) + ", " + std::to_string(m_header.tiltangles[2]) + ", " + std::to_string(m_header.tiltangles[3]) + ", " + std::to_string(m_header.tiltangles[4]) + ", " + std::to_string(m_header.tiltangles[5]) + "\n"
                                                                                                                                                                                                                                                                                                             "Origin: " +
                    std::to_string(m_header.origin[0]) + ", " + std::to_string(m_header.origin[1]) + ", " + std::to_string(m_header.origin[2]) + "\n"
                                                                                                                                                 "Map Format ID: " +
