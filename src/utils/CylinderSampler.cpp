    ...
    const std::array<float, 3> & axis_vector) const
{
    ...
    std::uniform_real_distribution<float> dist_r  (static_cast<float>(m_distance_min),
                                                   static_cast<float>(m_distance_max));
    std::uniform_real_distribution<float> dist_phi(0.0f, static_cast<float>(Constants::two_pi));
    std::uniform_real_distribution<float> dist_h  (static_cast<float>(-0.5 * m_height),
                                                   static_cast<float>(0.5 * m_height));
