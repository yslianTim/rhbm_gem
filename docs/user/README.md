...
1. Read [`docs/user/getting-started.md`](/docs/user/getting-started.md) to set up your environment, install the project, verify the Python bindings, and troubleshoot common setup issues.
...
5. Use [`docs/user/command/umap_embedding.md`](/docs/user/command/umap_embedding.md) to load a saved SQLite model and calculate two UMAP coordinates per selected atom.
