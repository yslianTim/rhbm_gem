...
3. Read [`architecture/command-architecture.md`](architecture/command-architecture.md) and [`architecture/dataobject-io-architecture.md`](architecture/dataobject-io-architecture.md) when you need architecture context for commands, data I/O, or persistence.
...
Editable diagram sources are stored under [`architecture/diagrams/`](architecture/diagrams/).
