...
7. Read [`docs/developer/estimate-local-gaussian-with-offset.md`](/docs/developer/estimate-local-gaussian-with-offset.md), [`docs/developer/second-stage-local-fitting.md`](/docs/developer/second-stage-local-fitting.md), and [`docs/developer/second-stage-outer-iteration-algorithm-audit.md`](/docs/developer/second-stage-outer-iteration-algorithm-audit.md) when changing Gaussian fitting internals or its convergence policy.
