...
7. Read [`docs/developer/estimate-local-gaussian-with-offset.md`](/docs/developer/estimate-local-gaussian-with-offset.md) and [`docs/developer/second-stage-local-fitting.md`](/docs/developer/second-stage-local-fitting.md) when changing Gaussian fitting internals.
