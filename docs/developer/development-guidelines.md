...
- `[Required]` For `user_version == 2`, schema admission must accept only the final catalog-based v2 shape. Any presence of legacy `object_metadata` or other non-final shapes must fail fast.
