...
Scaffold generated for CLI command `map_simulation`.

## Registration Checklist

1. Add `MapSimulationCommand` into `src/core/internal/BuiltInCommandList.def`.
2. Include `MapSimulationCommand.hpp` in `src/core/command/BuiltInCommandCatalog.cpp`.
