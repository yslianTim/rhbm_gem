...
Scaffold generated for CLI command `position_estimation`.

## Registration Checklist

1. Add `PositionEstimationCommand` into `src/core/internal/BuiltInCommandList.def`.
2. Include `PositionEstimationCommand.hpp` in `src/core/command/BuiltInCommandCatalog.cpp`.
