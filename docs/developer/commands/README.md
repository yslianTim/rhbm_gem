...
- [`/docs/developer/commands/potential_analysis.md`](/docs/developer/commands/potential_analysis.md) is the current deep-dive example for a complex database-backed command.
