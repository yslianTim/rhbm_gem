...
- Keep workflow-wide guidance in [`../adding-a-command.md`](../adding-a-command.md).
...
- [`potential_analysis.md`](potential_analysis.md) is the current deep-dive example for a complex database-backed command.
