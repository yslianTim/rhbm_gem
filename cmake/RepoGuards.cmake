...
function(rhbm_guard_check_hygiene)
    ...
    foreach(TRACKED_FILE IN LISTS TRACKED_FILE_LIST)
        ...
        elseif(TRACKED_FILE MATCHES "^[^/]+\\.sh$")
            list(APPEND HYGIENE_VIOLATIONS "${TRACKED_FILE} (root-level scripts must move under resources/tools/)")
...
function(rhbm_guard_run_install_smoke)
    ...
    foreach(required_cli_example
        ...
        if(NOT EXISTS "${CLI_EXAMPLE_INSTALL_DIR}/${required_cli_example}")
            message(FATAL_ERROR
                "Install consumer smoke test did not install expected CLI example: "
                "${CLI_EXAMPLE_INSTALL_DIR}/${required_cli_example}")
        endif()
    endforeach()
