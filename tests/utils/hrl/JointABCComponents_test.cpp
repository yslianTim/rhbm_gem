...
TEST(JointABCComponentsTest, StructuralGraphPreservesBridgeChainConstantAndUnobserved)
{
...
TEST(JointABCComponentsTest, SharedParentScaleAndDirectionsAreNotRenormalized)
{
...
TEST(JointABCComponentsTest, PartitionIDsSurviveStoragePermutationAndRejectMalformedCSR)
{
...
TEST(JointABCComponentsTest, RegisteredAuditDoesNotShrinkWithAComponent)
{
...
TEST(JointABCComponentsTest, EvaluationUsesParentScaleForBothKKTAndWidthGradient)
{
...
TEST(JointABCComponentsTest, ZeroObservationsAndUnderflowDoNotChangeStructuralPartition)
{
...
TEST(JointABCComponentsTest, PrecisionReferenceUsesFullParentObservations)
{
...
TEST(JointABCComponentsTest, SameStateIncludesResidualTermAndConstantRows)
{
...
TEST(JointABCComponentsTest, FiniteUntrustedStateKeepsRawParityWithoutProfileClaims)
{
...
TEST(JointABCComponentsTest, BlockBackendSharesConstrainedActiveSet)
{
...
TEST(JointABCComponentsTest, RankEvidenceUsesGlobalDimensionsAndCurrentSpectrum)
{
...
TEST(JointABCComponentsTest, FailureIsolationDoesNotFillMissingRowsWithZero)
{
...
TEST(JointABCComponentsTest, BudgetAndInvalidStartRetainHonestAvailability)
{
...
TEST(JointABCComponentsTest, BlockMultiprecisionReferenceMatchesDenseGlobalReference)
{
...
TEST(JointABCComponentsTest, UnobservedAtomsKeepRawPredictionButDisableProfileClaims)
{
...
TEST(JointABCComponentsTest, GlobalBlockBoundaryScanIncludesOtherComponentsAndConstants)
{
...
TEST(JointABCComponentsTest, LocalAuditUsesActualStateAndDiscardsSiblingDirections)
{
    const TwoBlocks f;
