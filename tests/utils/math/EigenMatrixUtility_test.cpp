...
TEST(EigenMatrixUtilityTest, GetStandardDeviationIdenticalElementsNoWarning)
{
...
TEST(EigenMatrixUtilityTest, DynamicInvertibleMatrixReturnsCorrectInverse)
{
...
TEST(EigenMatrixUtilityTest, DynamicSingularMatrixReturnsPseudoInverse)
{
...
TEST(EigenMatrixUtilityTest, ZeroDiagonalMatrixRemainsZeroAfterInverse)
{
