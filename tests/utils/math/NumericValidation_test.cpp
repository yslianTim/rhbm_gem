...
{
    EXPECT_EQ(3, rg::numeric_validation::RequirePositive(3, "count"));
    EXPECT_EQ(4u, rg::numeric_validation::RequirePositive(4u, "sample_count"));
}
...
TEST(NumericValidationTest, RequirePositiveRejectsZeroAndNegativeValues)
{
    ExpectInvalidArgumentMessage(
        []()
        {
            (void)rg::numeric_validation::RequirePositive(0, "count");
        },
        "count must be positive.");
    ExpectInvalidArgumentMessage(
        []()
        {
            (void)rg::numeric_validation::RequirePositive(-1, "count");
        },
        "count must be positive.");
}
...
TEST(NumericValidationTest, RequireFiniteRejectsNonFiniteValue)
{
    ExpectInvalidArgumentMessage(
        []()
        {
            (void)rg::numeric_validation::RequireFinite(
...
TEST(NumericValidationTest, RequireAllFiniteAcceptsFiniteVector)
{
    ...
    EXPECT_EQ(&values, &rg::numeric_validation::RequireAllFinite(values, "values"));
}
...
TEST(NumericValidationTest, RequireAllFiniteRejectsNonFiniteVectorValue)
{
    ...
    ExpectInvalidArgumentMessage(
        [&]()
        {
            (void)rg::numeric_validation::RequireAllFinite(values, "values");
        },
...
TEST(NumericValidationTest, RequireAllFiniteWithContextPrefixesOriginalMessage)
{
    ...
    ExpectInvalidArgumentMessage(
        [&]()
        {
            (void)rg::numeric_validation::RequireAllFinite(
                values,
                "values",
                "Invalid value list.");
        },
...
TEST(NumericValidationTest, RequireFinitePositiveRejectsNonPositiveAndNonFiniteValues)
{
    ExpectInvalidArgumentMessage(
        []()
        {
            (void)rg::numeric_validation::RequireFinitePositive(0.0, "width");
        },
        "width must be finite and positive.");
    ExpectInvalidArgumentMessage(
        []()
        {
            (void)rg::numeric_validation::RequireFinitePositive(
...
{
    EXPECT_DOUBLE_EQ(0.0, rg::numeric_validation::RequireFiniteNonNegative(0.0, "alpha"));
    ExpectInvalidArgumentMessage(
        []()
        {
...
{
    const auto range{
        rg::numeric_validation::RequireFiniteNonNegativeRange(0.0, 0.0, "distance range")
    };
...
TEST(NumericValidationTest, RequireFiniteNonNegativeRangeRejectsInvalidInputs)
{
    ExpectInvalidArgumentMessage(
        []()
        {
            (void)rg::numeric_validation::RequireFiniteNonNegativeRange(
                2.0,
                1.0,
                "distance range");
        },
...
TEST(NumericValidationTest, RequireFiniteInclusiveRangeAcceptsBoundsAndRejectsOutsideValues)
{
    EXPECT_DOUBLE_EQ(
        180.0,
        rg::numeric_validation::RequireFiniteInclusiveRange(180.0, 0.0, 180.0, "angle"));

    ExpectInvalidArgumentMessage(
        []()
        {
            (void)rg::numeric_validation::RequireFiniteInclusiveRange(181.0, 0.0, 180.0, "angle");
        },
        "angle must be finite and within [0, 180].");
    ExpectInvalidArgumentMessage(
        []()
        {
            (void)rg::numeric_validation::RequireFiniteInclusiveRange(
                std::numeric_limits<double>::quiet_NaN(),
                0.0,
                180.0,
                "angle");
