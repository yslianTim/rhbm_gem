...
TEST(DataObjectRuntimeBehaviorTest, PublicNeighborQueryReturnsDeterministicDistanceSortedNeighbors)
{
...
TEST(DataObjectRuntimeBehaviorTest, PublicNeighborQueryCanOptionallyIncludeCenterAtom)
{
    auto model{ MakeSpatialQueryModel() };
    const auto & atoms{ model->GetAtomList() };
...
TEST(DataObjectRuntimeBehaviorTest, PublicNeighborQueryRejectsInvalidInputs)
{
    auto model{ MakeSpatialQueryModel() };
...
TEST(DataObjectRuntimeBehaviorTest, PublicNeighborQueryRefreshesAfterAtomCoordinateChanges)
{
    auto model{ MakeSpatialQueryModel() };
    const auto & atoms{ model->GetAtomList() };
