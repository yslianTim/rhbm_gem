...
TEST(DataObjectSchemaValidationTest, ShadowSchemaBuildDoesNotUseIdentifierRewrite)
{
...
TEST(DataObjectSchemaValidationTest, MapDaoSaveDoesNotCreateSchemaImplicitly)
{
