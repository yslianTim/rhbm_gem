...
namespace { namespace m=second_stage_test::matched; }
TEST(JointComponentObservationTest, CompactStencilMatchesSamplerWithAnisotropicGridAndClampedEdges)
{
...
TEST(JointComponentObservationTest, KernelMatchesGeneratorIncludingBothCutoffsAndChargeSigns)
{
...
TEST(JointComponentObservationTest, StencilIncludesContributorsBeyondSampleCenterCutoff)
{
...
TEST(JointComponentObservationTest, QuantizationHappensAfterContributorSum)
{
...
TEST(JointComponentObservationTest, WidthDerivativesIncludeChargeCoupling)
{
