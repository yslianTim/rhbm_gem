...
public:
    ...
    static const std::vector<Residue> & GetStandardNucleotideList();
    static const std::vector<Element> & GetStandardElementList();
    static const std::unordered_map<std::string_view, Residue> & GetResidueMap();
    static const std::unordered_map<std::string_view, Element> & GetElementMap();
    static const std::unordered_map<std::string_view, Spot> & GetSpotMap();
    static const std::unordered_map<std::string_view, Link> & GetLinkMap();
    static const std::unordered_map<Element, std::string> & GetElementLabelMap();
