...
public:
    ...
    virtual void InsertGroupKey(const void * group_key) = 0;
    virtual void ReserveAtomObjectPtrList(const void * group_key, int size) = 0;
    ...
    virtual void AddGausEstimateMean(const void * group_key, double v0, double v1) = 0;
    virtual void AddGausEstimateMDPDE(const void * group_key, Eigen::VectorXd vec) = 0;
    virtual void AddGausEstimateMDPDE(const void * group_key, double v0, double v1) = 0;
    virtual void AddGausEstimatePrior(const void * group_key, Eigen::VectorXd vec) = 0;
    virtual void AddGausEstimatePrior(const void * group_key, double v0, double v1) = 0;
    virtual void AddGausVariancePrior(const void * group_key, Eigen::VectorXd vec) = 0;
    virtual void AddGausVariancePrior(const void * group_key, double v0, double v1) = 0;
    virtual int GetAtomObjectPtrListSize(const void * group_key) const = 0;
